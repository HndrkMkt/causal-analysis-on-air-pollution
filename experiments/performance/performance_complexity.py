"""
    This module performs a performance experiment for learning times varying complexity and different conditional independence tests
"""
...
def generate_DF(complexity = [5],instances = 1000,sample_sizes = [1000]):
    ...
    Args:
        complexity: A list containing different total number of raw features to include in the TIGRAMITE dataframes
        instances: Desired number of dataframes
        sample_sizes: The desired sample size
                ...
                while not stop:
                    try:
                        ...
                        if counts[i[0]] < limit:
                            ...
                            results_df.to_csv(
                                        'results/performance_complexity.csv',
                                        index=False)
