...
class FieldTest {
    ...
    void testBooleanField() {
        Field field = new Field("test", Boolean.class, true);
        Assertions.assertEquals(Types.BOOLEAN, field.getTypeInformation());
        field.setValue("0");
        Assertions.assertEquals(false, field.getValue());
        field.setValue("1");
        Assertions.assertEquals(true, field.getValue());
        field.setValue("null");
        Assertions.assertNull(field.getValue());
    }
